...
class BoilStepWithHopDropper(StepBase):
    ...
    hop_1 = Property.Number("Hop 1 Addition", default_value="-1", configurable=True, description="First Hop alert")
    ...
    hop_5 = Property.Number("Hop 5 Addition", default_value="-1", configurable=True, description="Fives Hop alert")
    ...
    hop_6 = Property.Number("Hop 6 Addition", default_value="-1", configurable=True, description="Sixth Hop alert")
    ...
    hop_7 = Property.Number("Hop 7 Addition", default_value="-1", configurable=True, description="Seventh Hop alert")
